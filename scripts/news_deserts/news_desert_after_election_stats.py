...
def news_deserts_csv_df(keywords):
    ...
    filepath = "/projects/canis/news_deserts/twitter/data/2018_12_0[6-9]*stream_1*"
    ...
    filepath = "/projects/canis/news_deserts/twitter/data/2018_12_[1-3][0-9]*stream_1*"
    ...
    filepath = "/projects/canis/news_deserts/twitter/data/2019_01_0[0-5]*stream_1*"
