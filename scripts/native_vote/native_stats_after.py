...
def native_vote_csv_df():
    ...
    filepath = "/projects/canis/nativevote18/twitter/data/2018_12_0[6-9]*stream_1*"
    ...
    filepath = "/projects/canis/nativevote18/twitter/data/2018_12_[1-3]*stream_1*"
    ...
    filepath = "/projects/canis/nativevote18/twitter/data/2019_01_0[0-5]*stream_1*"
