...
def native_vote_csv_df():
    ...
    # filepath = "/Users/tdt62/Desktop/test_data/2018_10*vote*"
    # Takes all of the csv file and makes one big dataframe
    for name in glob.glob(filepath):
    ...
    # filepath = "/Users/tdt62/Desktop/test_data/2018_11*vote*"
    ...
    filepath = "/projects/canis/nativevote18/twitter/data/2018_12_01*stream_1*"
